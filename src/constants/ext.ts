...
export const EXT_FOLDERLIST_ITEM_EMPTY_CTX = 'folder-list-item-empty';
export const EXT_FOLDERLIST_ITEM_LOADING_CTX = 'folder-list-item-loading';
export const EXT_LOADED = `${EXT}-folders-loaded`;
